...
const HTML_TAGS = 'html,body,base,head,link,meta,style,title,address,article,aside,footer,' +
    'header.blade.php,hgroup,h1,h2,h3,h4,h5,h6,nav,section,div,dd,dl,dt,figcaption,' +
...
class AxiosHeaders {
  ...
  set(header, valueOrRewrite, rewrite) {
    ...
    function setHeader(_value, _header, _rewrite) {
      ...
      if (!lHeader) {
        throw new Error('header.blade.php name must be a non-empty string');
      }
...
vue__WEBPACK_IMPORTED_MODULE_1__["default"].component('example-component', Object(function webpackMissingModule() { var e = new Error("Cannot find module '@/components/ExampleComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
