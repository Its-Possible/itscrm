<div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" placeholder="Nome do cliente" id="customer-name" name="name" form="customer-save" autocomplete="off" @if(!is_null($customer)) value="{{ decrypt_data($customer->name) }}" @endif />
    </div>
    <div class="form-group">
        <label for="customer-email">E-mail</label>
        <input class="form-control" type="email" placeholder="E-mail" id="customer-email" name="email" form="customer-save" autocomplete="off" @if(!is_null($customer)) value="{{ decrypt_data($customer->email) }}" @endif />
    </div>
    <div class="form-group">
        <label for="customer-username">Data de nascimento</label>
        <input class="form-control" type="date" id="customer-birthday" name="birthday" form="customer-save" autocomplete="off" @if(!is_null($customer)) value="{{ $customer->birthday }}" @endif />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" placeholder="Porta, Andar, Letra" id="customer-address-line-2" name="address-line-2" form="customer-save" autocomplete="off" @if(!is_null($customer)) value="{{ decrypt_data($customer->address_line_2) }}" @endif  />
    </div>
    <div class="row">
        <div class="col-md-5">
            <div class="form-group">
